...
<body>
	...
	<br>
	<!-- form action="LoginServlet/reset" method="post">
		Password:<input type="password" name="password" /><br /> Confirmed
		Password:<input type="password" name="re-password" /><br /> <input
				...
				<div class="col-sm-6 text-black">
					<div
						...
						<form style="width: 23rem;" method="post"
							action="<%=request.getContextPath()%>/LoginServlet/password?forgotName=<c:out value='${user.userName}' />">
							<!-- h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log
								in</h3 -->
							<h3 class="fw-normal mt-5 mb-4">Reset Password</h3>

							<div class="form-outline mb-4">
								<input type="text" id="form2Example18" name="password"
									class="form-control form-control-lg" /> <label
									class="form-label" for="form2Example18">Password</label>
							</div>

							<div class="form-outline mb-4">
								<input type="text" id="form2Example28" name="repassword"
									class="form-control form-control-lg" /> <label
									class="form-label" for="form2Example28">Re-enter
									Password</label>
							</div>
